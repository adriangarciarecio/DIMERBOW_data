...
#2 Counting total of interactions
```{r}
##INTERACTIONS#########################################################################################
...
#3 Counting interactions on each dimer
```{r}
#COUNTS
l_count_pdb <- c()
l_count_lz <- c()
...
#4 Analysis of the interactions
##RMSD
```{r}
##RMSD#########################################################################################
...
write.csv(resum, file = '/home/adrian/Documents/bender/RESULTS/dimer_analysis_2.csv', quote = F, row.names = F)
### TOP 20 ###
...
p1_a <- ggplot(time_data_1, aes(DIMER, RMSD_MEAN)) + 
  ylab('RMSD') +
...
p2_a <- ggplot(time_data_2, aes(DIMER, DEGREE_MEAN)) + 
  ylab('Degrees (º)') +
...
p3_a <- ggplot(time_data_3, aes(DIMER, DIST_MEAN)) + 
  coord_cartesian(ylim = c(30,80)) +
  ylab('Distance (A)') +
  geom_bar(position = "dodge", stat="identity", fill = '#ff8080', colour="#666666") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 9), axis.title.x = element_blank(), 
        axis.text.y = element_blank(), axis.title.y = element_blank()) +
...
gro_a <- ggplot(gro_data_asys_f, aes(x=as.factor(Dimers), y=value,  fill=variable)) + 
  ylab('Counts') +
  geom_bar(aes(fill = variable), position = "dodge", stat="identity", colour="#666666") +
  theme(axis.text.x = element_text(angle = 270, hjust = 1, vjust = 0.5, size = 9), legend.title = element_blank(), legend.direction = "horizontal", 
...
gro_s <- ggplot(gro_data_sys_f, aes(x=as.factor(Dimers), y=value,  fill=variable)) + 
  ylab('Counts') +
  geom_bar(aes(fill = variable), position = "dodge", stat="identity", colour="#666666") +
  theme(axis.text.x = element_text(angle = 270, hjust = 1, vjust = 0.5, size = 9), axis.title.y = element_text(size = 10), legend.title = element_blank(), legend.direction = "horizontal", 
        legend.position = c(0.85,0.85) , axis.title.x = element_blank(), 
...
#                     ncol = 1, nrow = 3)
# 
# p_as <- grid.arrange(p_s, p_a,
#                     ncol = 2, nrow = 1)
# 
# p <- grid.arrange(gro_s, gro_a,
#                     ncol = 2, nrow = 1)
# 
# p_end <- grid.arrange(p, p_as,
#                     ncol = 1, nrow = 2)
...
p_end <- plot_grid(
  ...
  , p3_a
  , ncol = 2
  , align = "v", axis = "b", labels = c("Symmetric", "Asymmetric"), label_size = 10)

ggsave(p_end, filename = "/home/adrian/Documents/bender/RESULTS/analysis.png", width = 18, height = 13 , dpi = 300)

# ggsave(p1_a, filename = "/home/adrian/Documents/bender/RESULTS/analysis_asys_rmsd.png", width = 13, height = 5, dpi = "retina")
# 
# ggsave(p2_a, filename = "/home/adrian/Documents/bender/RESULTS/analysis_asys_degree.png", width = 13, height = 5, dpi = "retina")
# 
# ggsave(p3_a, filename = "/home/adrian/Documents/bender/RESULTS/analysis_asys_dist.png", width = 13, height = 5, dpi = "retina")
# 
# ggsave(p1_s, filename = "/home/adrian/Documents/bender/RESULTS/analysis_sys_rmsd.png", width = 13, height = 5, dpi = "retina")
# 
# ggsave(p2_s, filename = "/home/adrian/Documents/bender/RESULTS/analysis_sys_degree.png", width = 13, height = 5, dpi = "retina")
# 
# ggsave(p3_s, filename = "/home/adrian/Documents/bender/RESULTS/analysis_sys_dist.png", width = 13, height = 5, dpi = "retina")
# 
# ggsave(gro_s, filename = "/home/adrian/Documents/bender/RESULTS/analysis_sys_gro.png", width = 13, height = 5, dpi = "retina")
# 
# ggsave(gro_a, filename = "/home/adrian/Documents/bender/RESULTS/analysis_asys_gro.png", width = 13, height = 5, dpi = "retina")
...
pdb_asys <- ggplot(pdb_data_asys, aes(Dimers, value)) + 
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5, size = 12), legend.title = element_blank(), legend.position = "none", 
        legend.direction = "horizontal", legend.text = element_text(size = 12),
        axis.title.x = element_blank(), axis.text.y = element_text(size = 12), axis.title.y = element_text(size = 12)) +
...
ggsave(c, filename = "/home/adrian/Documents/bender/RESULTS/counts_pdb.jpg", width = 20, height = 10, dpi = "retina")
...
ggsave(p, filename = "/home/adrian/Documents/bender/RESULTS/interactions_interfaces_asys_end_20.jpg", width = 10, height = 10, dpi = "retina")
...
ggsave(s, filename = "/home/adrian/Documents/bender/RESULTS/interficies_distribution_f.jpg", width = 10, height = 10, dpi = "retina")
```

##RELATION BETWEEN PARAMETERS
```{r}
info_all
s <- plot(resum$RMSD_MEAN, resum$DEGREE_MEAN, col= resum$DIMER)
abline(lm(resum$DEGREE_MEAN~resum$RMSD_MEAN))
text(resum$RMSD_MEAN, resum$DEGREE_MEAN, labels=resum$DIMER, cex= 0.5, pos = 2)
ggsave(s, filename = "/home/adrian/Documents/bender/RESULTS/degreevsrmsd.png", width = 10, height = 10, dpi = "retina")

s <- plot(resum$RMSD_MEAN, resum$DIST_MEAN, col= resum$DIMER)
abline(lm(resum$DIST_MEAN~resum$RMSD_MEAN))
text(resum$RMSD_MEAN, resum$DIST_MEAN, labels=resum$DIMER, cex= 0.5, pos = 2)
ggsave(s, filename = "/home/adrian/Documents/bender/RESULTS/distvsrmsd.png", width = 10, height = 10, dpi = "retina")

s <- plot(resum$DIST_MEAN, resum$DEGREE_MEAN, col= resum$DIMER)
abline(lm(resum$DEGREE_MEAN~resum$DIST_MEAN))
text(resum$DIST_MEAN, resum$DEGREE_MEAN, labels=resum$DIMER, cex= 0.5, pos = 2)
ggsave(s, filename = "/home/adrian/Documents/bender/RESULTS/degreevsdist.png", width = 10, height = 10, dpi = "retina")
```
